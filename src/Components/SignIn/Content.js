                                ...
                                <div class="card border-grey border-lighten-3 px-1 py-1 m-0">
                                    ...
                                    <div class="card-content">
                                        <div class="card-body">
                                            <form class="form-horizontal" action="#" novalidate="">
                                                <fieldset class="form-group position-relative has-icon-left">
                                                    <input type="email" class="form-control round" id="user-names" placeholder="電郵地址" required />
                                                    <div class="form-control-position">
                                                        <i class="ft-user"></i>
                                                    </div>
                                                </fieldset>
                                                <fieldset class="form-group position-relative has-icon-left">
                                                    <input type="password" class="form-control round" id="user-passwords" placeholder="密碼"
                                                        required />
                                                    <div class="form-control-position">
                                                        <i class="ft-lock"></i>
                                                    </div>
                                        ...
                                        <p class="card-subtitle text-muted text-right font-small-3 mx-2 my-1">
                                            <span>沒有帳戶 ?
                                                <a href="/sign_up" class="card-link">註冊新帳號</a>
                                            </span>
                                        </p>
